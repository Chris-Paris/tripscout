...
const findRelevantInterests = (description: string = '', interests: string[] = [], language: string) => {
            ...
            {type === 'itinerary' ? (
              ...
              <>
                {allItems.map((item, index) => {
                  const relevantInterests = findRelevantInterests(item?.description, interests, language);
                  return (
                    <div key={index} className="border-b pb-4 last:border-b-0">
